...
public class mainApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setOnCloseRequest(event -> {
            ...
            try {
                writingToFiles.writeTotalBill("res/totalBill1.bin",BillView.total);
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            try {
                writingToFiles.writeTotalCost("res/totalCost1.bin",Controller.totalCost);
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            writingToFiles.writeBooksSold("res/booksSold1.bin",BillView.booksSold);
